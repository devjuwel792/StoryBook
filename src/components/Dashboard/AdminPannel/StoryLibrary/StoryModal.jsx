  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-2 sm:p-6">
      <div className="relative w-full max-w-4xl max-h-[90vh] bg-white rounded-3xl shadow-xl outline outline-4 outline-offset-[-4px] outline-indigo-100/40 flex flex-col flex-1">
        ...
        {/* Pagination */}
        <div className="w-full max-w-2xl h-12 mx-auto mt-5 mb-10 flex justify-between items-center px-4 headerFont">
          <button
            className="w-48 h-12 bg-gradient-to-r from-red-200 to-orange-200 rounded-full shadow-lg flex items-center justify-center text-white text-[10px] font-bold"
          ...
          <div className="w-48 h-6 flex items-center justify-center">
            <span className="text-gray-600 text-[10px] font-normal leading-6">
              Page {page} of {totalPages}
            </span>
          </div>
          <button
            className="w-48 h-12 bg-gradient-to-r from-gray-800 to-emerald-200 rounded-full shadow-lg flex items-center justify-center text-white text-[10px] font-bold"
