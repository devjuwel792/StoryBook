    ...
    >
      <div className="p-28 px-36">
        <div className="flex justify-between">
          ...
          <div className="flex gap-6">
            <button
              ...
              className="bg-white px-8 font-semibold rounded-3xl"
            >
              Sign In
            </button>
            <button
              ...
              className="bg-white px-9 font-semibold rounded-3xl"
            >
              Sign Up Free
            </button>
          </div>
        ...
        <div className="mt-5 relative">
          <p className="text-[60px] font-semibold flex justify-center items-center gap-5 text-white text-center">
          ...
          <p className="absolute left-1/4 text-5xl animate-pulse">✨</p>
        </div>
      </div>
    </div>
  );
